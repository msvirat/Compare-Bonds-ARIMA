...
def main():
    ...
    if choice == 'Forecast':
        ...
        if st.button("Forecast"):
            ...
            st.subheader("[Neha Shirbhate] (https://www.linkedin.com/in/neha-shirbhate) ")
            ...
            st.subheader("[Shubham Undirwade] (https://www.linkedin.com/in/shubham-undirwade)")
            ...
            st.subheader("[Yash Bohra] (http://linkedin.com/in/yash-bohra1) ")
